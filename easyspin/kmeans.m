% kmeans  Perform k-means clustering on input data using random
%         initialization
%
%   [idxStates,centroids] = kmeans(data,nClusters,nRepeats)
%
%
...
function [idxClusters, centroids] = kmeans_mine(data,nClusters,nRepeats,verbosity)
