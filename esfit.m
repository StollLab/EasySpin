...
StartpointNames{3} = 'selected fit set';
...
if (FitData.GUI)
  ...
  h = plot(hAx,...
    ...
    1:Exp.nPoints,NaNdata,'g',...
    1:Exp.nPoints,NaNdata,'r');
  ...
  title('log10(rmsd)','Color','k','FontSize',7);
