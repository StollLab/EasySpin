...
% of the nitroxide, with the coordinates rigidly rotated between the two.
% The rotation matrix is determined from the atom coordinates, and all
% tensors (g, A, Q) must transform with this rotation.
