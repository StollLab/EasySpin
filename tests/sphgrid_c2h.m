...
idx = sortrows(uint32([1 2 3; 2 4 7; 2 3 7; 3 5 6; 3 6 7; 1 2 3; 2 3 5; 2 4 5]));
areas = [1.3593, 1.3593, 2.2051, 1.3593, 1.3593, 1.3593, 2.2051, 1.3593];
...
ok(6) = areequal(areas(:),tri.areas(:),1e-4,'abs');
