...
% Test whether esfit() returns correct confidence intervals (CIs).
% This test compares esfit()'s CI values to CI values obtained from
...
result = esfit(y,fcn,p0,lb,ub,FitOpt);

% Reference parameter standard deviations, determined using MATLAB's
% Curve Fitting Tool and DeerLab's fitparamodel.
