...
% Read ORCA 6 output from a relaxed surface scan (%geom Scan) of the
% hydroxyl radical: O-H distance scanned from 1.0 to 1.3 Angstrom in
% 4 steps, with EPR properties calculated at each step.
%   ok(1)  main output file (.out)
%   ok(2)  property file (.property.txt)
%   ok(3)  main output and property file agree for each step

name = 'orca/v6.1.0/hydroxyl_optscan';
