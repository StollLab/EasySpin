...
% Test whether the tensor output of ham_ezho is identical to the full matrix output
...
B = rand(3,1);
H{1} = ham_ezho(Sys,B,[],'sparse',0);
H{2} = ham_ezho(Sys,B,[],'sparse',1);
H{3} = ham_ezho(Sys,B,[],'sparse',2);
H{4} = ham_ezho(Sys,B,[],'sparse',3);
