...
if ~isempty(olddata)
  err = ~areequal(olddata.TransProb,HMM.TransProb,1e-10,'abs') || ...
        ~areequal(olddata.eqDistr,HMM.eqDistr,1e-10,'abs') || ...
        ~areequal(olddata.stateTraj,HMM.stateTraj,1e-10,'abs');
else
  err = [];
end
